...
//        headline:"А вот и не дам!!! Как ты замучил таскать замечания в дневнике каждый день, когда уже мозги включишь?",
        image: "strawberry",
...
//        headline:"Если будешь смелым, внимательным и начнешь думать головой. Станешь таким как твой Папа и будешь такие же штуки создавать в будущем. Жми Start",
        image: "lemon",
